...
CFLAGS = $(BASE_CFLAGS) $(ADD1) $(ADD2) `gnustep-config --objc-flags`
...
OBJ = $(CFILES:.m=.o)
OBJ_SOUND = $(OBJ) $(SOUND_CFILES:.m=.o)
...
gltron_sound: $(OBJ_SOUND)
	$(CC) $(OPT) `gnustep-config --objc-libs` -o gltron $(OBJ_SOUND) $(GL_LIBS) $(XLIBS) $(SNDLIBS) -lobjc -lgnustep-base -lgnustep-gui
