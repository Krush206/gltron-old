...
extern MMenu** pMenuList;
extern MMenu* pRootMenu;
extern MMenu* pCurrent;
...
extern void menuAction(MMenu* activated, int type);
extern MMenu** loadMenuFile(char* filename);
extern void drawMenu(gDisplay *d);
extern void showMenu();
extern void removeMenu();
extern void initMenuCaption(MMenu *m);
